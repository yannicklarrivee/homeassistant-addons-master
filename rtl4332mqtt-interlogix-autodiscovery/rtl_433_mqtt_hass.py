...
options_dict = json.loads(options_file.read())
MQTT_HOST = options_dict["mqtt_host"] #"homeassistant"
MQTT_PORT = 1883
MQTT_TOPIC = options_dict["mqtt_topic"] + "/devices/+/+/+/events"
